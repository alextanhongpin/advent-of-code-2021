...
func main() {
	fmt.Println("part1 (example):", part1(example)) // 26
	fmt.Println("part1 (input):", part1(input))     // 303

	fmt.Println("part2 (example):", part2(example))  // 61229
	fmt.Println("part2 (example):", part2(example2)) // 5353
	fmt.Println("part2 (input):", part2(input))      // 961734
}
...
var example2 = `acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab | cdfeb fcadb cdfeb cdbaf`
...
var input = `ecfdbg decfba aegd fdcag fagecd gd gcafb efdac cbgeafd dfg | bgacf afdebc fceda cabfg
